...
static const int pinOutDirection = 2; // Arduino digital pin connected to Driver direction
...
static const float SIDERAL_TIME_EARTH_REVOLUTION = 86164.1; //seconds
static const float MAX_THETA = 30.0; //degrees

static const float DISTANCE_ROD_TO_HINGE = 830.0; //milimeters
static const float INITIAL_APERTURE = 27.0; //milimeters
static const float STEPS_DEGREES = 1.8;
static const float MICRO_STEPS_PER_STEPS = 16;
static const float STEPS_PER_REVOLUTION = 360.0 / (STEPS_DEGREES / MICRO_STEPS_PER_STEPS);
static const float THREAD_ROD_PITCH = 2; //milimeters
